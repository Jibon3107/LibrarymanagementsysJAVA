...
class Reg extends JFrame implements ActionListener, MouseListener {
	...
	public Reg(){
		...
		this.lblName = new JLabel("Please Sign Up");
		...
		this.btnAdd = new JButton("Sign Up");
		...
		this.lblName.setBounds(250,40,300,50);
		...
		this.btnAdd.setBounds(275,530,100,30);
		this.btnBack.setBounds(430,570,100,30);
 	...
 	public void actionPerformed(ActionEvent e){
		if(e.getSource()==btnBack){
			...
			if (tx2.getText().isEmpty() || tx3.getText().isEmpty() || tx4.getText().isEmpty() || tx5.getText().isEmpty() || tx7.getText().isEmpty() || tx8.getText().isEmpty() )
			{
...
public void DBConnect()
		{
			...
			Statement st = null;
			ResultSet rs = null;
			String query="insert into member (Name, EMail, Address, Contact, Status,Fine, UserName, Password) values ('"+LibName+"','"+LibMail+"','"+LibAddress+"','"+LibContact+"','0','0','"+LibUserName+"','"+LibPass+"');";			
